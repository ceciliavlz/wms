...
public class PesoUbicacionesRack extends javax.swing.JPanel {
     ...
     */
    public PesoUbicacionesRack(NaveController naveCtrl) {
    ...
    private void pintarPesos(){
        List<String> pesosResp = naveCtrl.calcularPesosRack(idRack);
        Collections.sort(pesosResp);
        String[] pesos = pesosResp.toArray(new String[0]);
        ...
        for (int i = 1; i < 4; i++){
            for (int j = 1; j < 4; j++){
                ...
                String codigo = pesos[index].split(" ")[0].split(":")[0];

                JLabel label = buscarLabelPorNombreEnPanel(this, nombre);
                
                if (label != null) {
                    boolean llena = naveCtrl.ubicacionLlena(codigo);
                    if (!llena){
                        label.setText(peso);                     
                    } else{
